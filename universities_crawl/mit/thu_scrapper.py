...
EMAIL_DOMAIN=AFFILIATION='tsinghua'

RESULT_PATH = Path.cwd().parents[1] / 'result/THU'
RESULT_PATH.exists()
thu_name_list=RESULT_PATH.joinpath('thu_faculty_name_pinyin_list.txt').read_text(encoding='utf8').split('\n')
...
#
#
with open(RESULT_PATH/'thu_pi_google_scholar_info.json', 'w') as f:
