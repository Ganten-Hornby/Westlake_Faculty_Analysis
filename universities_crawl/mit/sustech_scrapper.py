...
EMAIL_DOMAIN='sustech'
AFFILIATION='southern university'

RESULT_PATH = Path.cwd().parents[1] / 'result/sustech'
RESULT_PATH.exists()
thu_name_list=RESULT_PATH.joinpath('sustech_faculty_name_pinyin_list.txt').read_text(encoding='utf8').split('\n')
...
#
#
with open(RESULT_PATH/'sustech_pi_google_scholar_info.json', 'w') as f:
